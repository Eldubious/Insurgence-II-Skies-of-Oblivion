...
const attributeMapping = {
    ...
    "attribute.name.bounciness": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.air_drag_modifier": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.friction_modifier": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.stardew_fishing.bar_size": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.stardew_fishing.exp_multiplier": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.stardew_fishing.golden_chest_bonus": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.stardew_fishing.line_strength": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.name.stardew_fishing.treasure_chance_bonus": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.tunes_n_tomes.melody_spell_power": Component.literal("").font("minecraft:include/").color("#FFFFFF"),
    "attribute.tunes_n_tomes.melody_magic_resist": Component.literal("").font("minecraft:include/").color("#FFFFFF")
};
