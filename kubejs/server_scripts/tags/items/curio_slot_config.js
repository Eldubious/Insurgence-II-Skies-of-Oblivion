...
ServerEvents.tags("item", event => {
    ...
    let compassItems = [
        "minecraft:compass", "minecraft:recovery_compass", "minecraft:map", "minecraft:filled_map",
    ...
    let bundleItems = [
        "quark:seed_pouch", "minecraft:bundle", "minecraft:white_bundle", "minecraft:light_gray_bundle",
    ...
    let headItems = [
        "cataclysm:unbreakable_skull", "aeronautics:aviators_goggles"
    ];
    let ringItems = [
    ...
    for (let i in beltItems) {
        event.add("curios:belt", beltItems[i]);
    }
    for (let i in headItems) {
        event.add("curios:head", headItems[i]);
    }
    for (let i in ringItems) {
        event.add("curios:ring", ringItems[i]);
    }
    ...
    event.remove("curios:talisman", "cataclysm:unbreakable_skull");
