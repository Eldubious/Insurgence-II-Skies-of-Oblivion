...
ServerEvents.tags("item", event => {
    ...
    let uniqueRings = [
        ...
        "malum:gilded_ring", "malum:ornate_ring", "malum:ring_of_esoteric_spoils", "malum:ring_of_the_rising_edge",
        "malum:ring_of_the_howling_maelstrom", "malum:ring_of_curative_talent", "malum:ring_of_arcane_prowess",
        "malum:ring_of_manaweaving", "malum:ring_of_alchemical_mastery", "malum:ring_of_desperate_voracity",
        "malum:ring_of_the_hoarder", "malum:ring_of_the_demolitionist", "cataclysm:ring_of_grudged"
    ];
    for (let i in uniqueRings) uniqueItemTags("ring", uniqueRings[i]);

    let uniqueBelts = [
        "relics:kinetic_belt", "relics:hunting_belt", "malum:belt_of_the_starved",
        "malum:belt_of_the_prospector", "malum:belt_of_the_magebane", "malum:gilded_belt"
    ];
    ...
    let uniqueNecklaces = [
        ...
        "relics:jellyfish_necklace", "relics:reflective_necklace", "malum:ornate_necklace",
        "malum:necklace_of_the_mystic_mirror", "malum:necklace_of_the_narrow_edge",
        "malum:necklace_of_blissful_harmony", "cataclysm:berserker_soul_amulet",
        "cataclysm:vitality_ankh"
    ];
    for (let i in uniqueNecklaces) uniqueItemTags("necklace", uniqueNecklaces[i]);

    let uniqueCloaks = [
        "relics:leafy_mantle", "relics:midnight_mantle", "relics:ghostly_mantle", "relics:glitchy_mantle"
    ];
    for (let i in uniqueCloaks) uniqueItemTags("cloak", uniqueCloaks[i]);

    let uniqueMasks = [
        "relics:piglin_mask", "cataclysm:unbreakable_skull"
    ];
    for (let i in uniqueMasks) uniqueItemTags("mask", uniqueMasks[i]);

    let uniqueShoes = [
        "relics:springy_boot", "relics:roller_skate", "relics:cut_glass_boot", "cataclysm:sturdy_boots"
    ];
    ...
    let uniqueCurios = [
        ...
        "cataclysm:chitin_claw", "cataclysm:blazing_grips"
    ];
    ...
    let uniqueShields = [
      ...
      "endermanoverhaul:corrupted_shield", "relics:shield_of_retaliation"
    ];
